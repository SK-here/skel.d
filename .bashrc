...
unset rc
 ...
 #                                                                                      #
 #	INSTALLATION:                                                            	#
 #	Copy this script to your home folder and rename it to ".fancy-prompt"    	#
 #	Run this command from any terminal:                                      	#
 #		echo "source ~/.fancy-promt" >> ~/.bashrc                        	#
 #                                                                                      #
 ...
 #	https://wiki.chakralinux.org/index.php?title=Color_Bash_PromptWolfman.27s	#
 ########################################################################################
...
bash_prompt() {
 ...
 ###########################################################################
 # CONFIGURATION                                                          ##
 # I also use them for different hosts.                                   ##
 ###########################################################################

######################## DEFAULT CONFIGURATION #############################

	# Host
	FONT_COLOR_1=$RED; BACKGROUND_1=$WHITE; TEXTEFFECT_1=$BOLD
	...
	if [ "$USER" = root ]; then
		...
		FONT_COLOR_3=$RED; BACKGROUND_3=$WHITE; TEXTEFFECT_2=$BOLD
	fi
...
################ Configuration for other hosts ##########################
	...
	if [ "$(hostname -s)" = servera ]; then

		# Host
		FONT_COLOR_1=$BLACK; BACKGROUND_1=$L_YELLOW; TEXTEFFECT_1=$BOLD
		...
		if [ "$USER" = root ]; then
			FONT_COLOR_1=$WHITE; BACKGROUND_1=$RED; TEXTEFFECT_1=$BOLD
			FONT_COLOR_3=$BLACK; BACKGROUND_3=$L_YELLOW; TEXTEFFECT_3=$BOLD
		fi
	...
	if [ "$(hostname -s)" = serverc ]; then
		...
		if [ "$USER" = root ]; then
			FONT_COLOR_1=$WHITE; BACKGROUND_1=$RED; TEXTEFFECT_1=$BOLD
			FONT_COLOR_3=$BLACK; BACKGROUND_3=$CYAN; TEXTEFFECT_3=$BOLD
		fi
	...
	## CONFIGURATION for node4
	if [ "$(hostname -s)" = serverd ]; then

		# Host
		FONT_COLOR_1=$WHITE; BACKGROUND_1=$YELLOW; TEXTEFFECT_1=$BOLD
		...
		if [ "$USER" = root ]; then
			FONT_COLOR_1=$WHITE; BACKGROUND_1=$RED; TEXTEFFECT_1=$BOLD
			FONT_COLOR_3=$WHITE; BACKGROUND_3=$YELLOW; TEXTEFFECT_3=$BOLD
		fi
...
alias vi='vim'
alias ip='ip --color'
alias ll='ls -lhtRa --color=auto'
alias fw='firewall-cmd'
alias vm='vboxmanage'
alias tree='tree -aphug -I .git'
